...
def get_compiler_version_ex(env):
    ...
    if env.msvc and not using_clang(env):
        try:
            ...
            # https://github.com/gnuchanideengine/gnuchanide/pull/91069#issuecomment-2358956731
            # https://github.com/gnuchanideengine/gnuchanide/pull/91069#issuecomment-2380836341
            args = [
                env["VSWHERE"],
                "-latest",
                "-prerelease",
