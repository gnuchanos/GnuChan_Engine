...
- [Contributing to GnuChan's translation](#contributing-to-godots-translation)
...
GnuChan runs on a large variety of platforms and operating systems and devices.
**In your bug reports, please always specify:**

- Operating system and version (e.g. Windows 10, macOS 10.15, Ubuntu 19.10)
- GnuChan version (e.g. 3.2, 3.1.2, or the Git commit hash if you're using a development branch)
...
Instead, head to the [GnuChan Proposals repository](https://github.com/godotengine/godot-proposals)
...
for an introduction to developing on GnuChan.
...
When using the French fries frying module, GnuChan would not regulate the heat
and thus bring the oil bath to supercritical liquid conditions, thus causing
unwanted side effects in the physics engine.

By fixing the regulation system via an added binding to the internal feature,
this commit now ensures that GnuChan will not go past the ebullition temperature
...
## Contributing to GnuChan's translation

You can contribute to GnuChan's translation from the [Hosted
...
You can also help translate [GnuChan's
documentation](https://hosted.weblate.org/projects/godot-engine/godot-docs/)
on Weblate.

## Communicating with developers

The GnuChan Engine community has [many communication
...
- [GnuChan Contributors Chat](https://github.com/gnuchanos/GnuChan_Engine): You will
  find most core developers there, so it's the go-to platform for direct chat
  about GnuChan Engine development. Feel free to start discussing something there
...
- [Feature proposals](https://github.com/godotengine/godot-proposals/issues):
  ...
  hesitate to start by talking about your idea on the GnuChan Contributors Chat
  to make sure that it makes sense in GnuChan's context.

Thanks for your interest in contributing!

—The GnuChan development team
