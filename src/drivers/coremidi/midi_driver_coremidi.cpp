...
Error MIDIDriverCoreMidi::open() {
	CFStringRef name = CFStringCreateWithCString(NULL, "GnuChan", kCFStringEncodingASCII);
	...
	result = MIDIInputPortCreate(client, CFSTR("GnuChan Input"), MIDIDriverCoreMidi::read, (void *)this, &port_in);
	if (result != noErr) {
