...
#ifndef RASTERIZER_SCENE_GLES4_H
#define RASTERIZER_SCENE_GLES4_H

/* Must come before shaders or the Windows build fails... */
#include "rasterizer_storage_gles4.h"

#include "drivers/gles4/shaders/cube_to_dp.glsl.gen.h"
#include "drivers/gles4/shaders/effect_blur.glsl.gen.h"
#include "drivers/gles4/shaders/exposure.glsl.gen.h"
#include "drivers/gles4/shaders/resolve.glsl.gen.h"
#include "drivers/gles4/shaders/scene.glsl.gen.h"
#include "drivers/gles4/shaders/screen_space_reflection.glsl.gen.h"
#include "drivers/gles4/shaders/ssao.glsl.gen.h"
#include "drivers/gles4/shaders/ssao_blur.glsl.gen.h"
#include "drivers/gles4/shaders/ssao_minify.glsl.gen.h"
#include "drivers/gles4/shaders/subsurf_scattering.glsl.gen.h"
#include "drivers/gles4/shaders/tonemap.glsl.gen.h"

class RasterizerSceneGLES4 : public RasterizerScene {
public:
	...
	Vector<RasterizerStorageGLES4::RenderTarget::Exposure> exposure_shrink;
	...
	struct State {
		...
		SceneShaderGLES4 scene_shader;
		CubeToDpShaderGLES4 cube_to_dp_shader;
		ResolveShaderGLES4 resolve_shader;
		ScreenSpaceReflectionShaderGLES4 ssr_shader;
		EffectBlurShaderGLES4 effect_blur_shader;
		SubsurfScatteringShaderGLES4 sss_shader;
		SsaoMinifyShaderGLES4 ssao_minify_shader;
		SsaoShaderGLES4 ssao_shader;
		SsaoBlurShaderGLES4 ssao_blur_shader;
		ExposureShaderGLES4 exposure_shader;
		TonemapShaderGLES4 tonemap_shader;
	...
	struct ReflectionProbeInstance : public RID_Data {
		RasterizerStorageGLES4::ReflectionProbe *probe_ptr;
		RID probe;
		RID self;
		RID atlas;
	...
	struct LightInstance : public RID_Data {
		...
		RID self;
		RID light;
		RasterizerStorageGLES4::Light *light_ptr;
		Transform transform;
	...
	struct GIProbeInstance : public RID_Data {
		RID data;
		RasterizerStorageGLES4::GIProbe *probe;
		GLuint tex_cache;
...
#define SORT_KEY_VERTEX_LIT_FLAG (uint64_t(1) << 44)
		...
		struct Element {
			...
			RasterizerStorageGLES4::Geometry *geometry;
			RasterizerStorageGLES4::Material *material;
			RasterizerStorageGLES4::GeometryOwner *owner;
			uint64_t sort_key;
		};
	...
	_FORCE_INLINE_ bool _setup_material(RasterizerStorageGLES4::Material *p_material, bool p_depth_pass, bool p_alpha_pass);
	...
	void _render_list(RenderList::Element **p_elements, int p_element_count, const Transform &p_view_transform, const CameraMatrix &p_projection, RasterizerStorageGLES4::Sky *p_sky, bool p_reverse_cull, bool p_alpha_pass, bool p_shadow, bool p_directional_add, bool p_directional_shadows);

	_FORCE_INLINE_ void _add_geometry(RasterizerStorageGLES4::Geometry *p_geometry, InstanceBase *p_instance, RasterizerStorageGLES4::GeometryOwner *p_owner, int p_material, bool p_depth_pass, bool p_shadow_pass);

	_FORCE_INLINE_ void _add_geometry_with_material(RasterizerStorageGLES4::Geometry *p_geometry, InstanceBase *p_instance, RasterizerStorageGLES4::GeometryOwner *p_owner, RasterizerStorageGLES4::Material *p_material, bool p_depth_pass, bool p_shadow_pass);

	void _draw_sky(RasterizerStorageGLES4::Sky *p_sky, const CameraMatrix &p_projection, const Transform &p_transform, bool p_vflip, float p_custom_fov, float p_energy, const Basis &p_sky_orientation);
...
public:
	...
	void initialize();
	void finalize();
	RasterizerSceneGLES4();
	~RasterizerSceneGLES4();
};

#endif // RASTERIZER_SCENE_GLES4_H
