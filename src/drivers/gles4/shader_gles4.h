...
#ifndef SHADER_GLES4_H
#define SHADER_GLES4_H
...
public:
	static ShaderCacheGLES4 *shader_cache;
...
public:
	...
	static _FORCE_INLINE_ ShaderGLES4 *get_active() { return active; };
	bool bind();
	void unbind();
...
int ShaderGLES4::_get_uniform(int p_which) const {
	ERR_FAIL_INDEX_V(p_which, uniform_count, -1);
	ERR_FAIL_COND_V(!version, -1);
	return version->uniform_location[p_which];
}

void ShaderGLES4::_set_conditional(int p_which, bool p_value) {
