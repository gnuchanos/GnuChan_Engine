...
#ifndef RASTERIZER_STORAGE_GLES4_H
#define RASTERIZER_STORAGE_GLES4_H

#include "core/bitfield_dynamic.h"
#include "core/self_list.h"
#include "drivers/gles_common/rasterizer_asserts.h"
#include "drivers/gles_common/rasterizer_storage_gles_shared.h"
#include "servers/visual/rasterizer.h"
#include "servers/visual/shader_language.h"
#include "shader_cache_gles4.h"
#include "shader_compiler_gles4.h"
...
class RasterizerStorageGLES4 : public RasterizerStorage {
public:
	RasterizerCanvasGLES4 *canvas;
	RasterizerSceneGLES4 *scene;
	...
	mutable struct Shaders {
		CopyShaderGLES4 copy;

		ShaderCompilerGLES4 compiler;
		ShaderCacheGLES4 *cache;
		ThreadedCallableQueue<GLuint> *cache_write_queue;
		ThreadedCallableQueue<GLuint> *compile_queue;

		CubemapFilterShaderGLES4 cubemap_filter;

		BlendShapeShaderGLES4 blend_shapes;

		ParticlesShaderGLES4 particles;

		ShaderCompilerGLES4::IdentifierActions actions_canvas;
		ShaderCompilerGLES4::IdentifierActions actions_scene;
		ShaderCompilerGLES4::IdentifierActions actions_particles;
	} shaders;
...
// NOTE : THESE SIZES ARE IN BYTES. BUFFER SIZES MAY NOT BE SPECIFIED IN BYTES SO REMEMBER TO CONVERT THEM WHEN CALLING.
inline bool RasterizerStorageGLES4::safe_buffer_sub_data(unsigned int p_total_buffer_size_bytes, GLenum p_target, unsigned int p_offset_bytes, unsigned int p_data_size_bytes, const void *p_data, unsigned int &r_offset_after_bytes) const {
...
// standardize the orphan / upload in one place so it can be changed per platform as necessary
// NOTE : THESE SIZES ARE IN BYTES.
inline void RasterizerStorageGLES4::buffer_orphan_and_upload(unsigned int p_buffer_size_bytes, unsigned int p_offset_bytes, unsigned int p_data_size_bytes, const void *p_data, GLenum p_target, GLenum p_usage, bool p_optional_orphan) const {
...
#endif // RASTERIZER_STORAGE_GLES4_H
