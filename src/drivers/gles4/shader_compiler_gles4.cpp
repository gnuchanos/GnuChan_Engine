...
void ShaderCompilerGLES4::_dump_function_deps(const SL::ShaderNode *p_node, const StringName &p_for_func, const Map<StringName, String> &p_func_code, String &r_to_add, Set<StringName> &added) {
	int fidx = -1;
...
String ShaderCompilerGLES4::_dump_node_code(const SL::Node *p_node, int p_level, GeneratedCode &r_gen_code, IdentifierActions &p_actions, const DefaultIdentifierActions &p_default_actions, bool p_assigning, bool p_use_scope) {
	String code;
...
Error ShaderCompilerGLES4::compile(VS::ShaderMode p_mode, const String &p_code, IdentifierActions *p_actions, const String &p_path, GeneratedCode &r_gen_code) {
...
ShaderCompilerGLES4::ShaderCompilerGLES4() {
	/** CANVAS ITEM SHADER **/
