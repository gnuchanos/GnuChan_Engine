...
to run without Administrator privileges and can optionally add GnuChan to the
...
- Place a GnuChan editor executable in this folder and rename it to `godot.exe`.
