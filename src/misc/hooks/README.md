# Git hooks for GnuChan Engine

This folder contains Git hooks meant to be installed locally by GnuChan Engine
...
matches `pre-commit-custom-*`, after the GnuChan ones.
