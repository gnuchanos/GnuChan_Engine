...
if (
    ...
    print("FATAL ERROR: GnuChan has been crashed.")
    sys.exit(1)

# Finding memory leaks in GnuChan is quite difficult, because we need to take into
...
# It may happen that GnuChan detects leaking nodes/resources and removes them, so
