...
VisualServer::VisualServer() {
	...
	force_shader_fallbacks = GLOBAL_GET("rendering/gles4/shaders/debug_shader_fallbacks");
	}
#endif
	GLOBAL_DEF("rendering/gles4/shaders/shader_compilation_mode", 0);
	ProjectSettings::get_singleton()->set_custom_property_info("rendering/gles4/shaders/shader_compilation_mode", PropertyInfo(Variant::INT, "rendering/gles4/shaders/shader_compilation_mode", PROPERTY_HINT_ENUM, "Synchronous,Asynchronous,Asynchronous + Cache"));
	GLOBAL_DEF("rendering/gles4/shaders/shader_compilation_mode.mobile", 0);
	GLOBAL_DEF("rendering/gles4/shaders/shader_compilation_mode.web", 0);
	GLOBAL_DEF("rendering/gles4/shaders/max_simultaneous_compiles", 2);
	ProjectSettings::get_singleton()->set_custom_property_info("rendering/gles4/shaders/max_simultaneous_compiles", PropertyInfo(Variant::INT, "rendering/gles4/shaders/max_simultaneous_compiles", PROPERTY_HINT_RANGE, "1,8,1"));
	GLOBAL_DEF("rendering/gles4/shaders/max_simultaneous_compiles.mobile", 1);
	GLOBAL_DEF("rendering/gles4/shaders/max_simultaneous_compiles.web", 1);
	GLOBAL_DEF("rendering/gles4/shaders/log_active_async_compiles_count", false);
	GLOBAL_DEF("rendering/gles4/shaders/shader_cache_size_mb", 512);
	ProjectSettings::get_singleton()->set_custom_property_info("rendering/gles4/shaders/shader_cache_size_mb", PropertyInfo(Variant::INT, "rendering/gles4/shaders/shader_cache_size_mb", PROPERTY_HINT_RANGE, "128,4096,128"));
	GLOBAL_DEF("rendering/gles4/shaders/shader_cache_size_mb.mobile", 128);
	GLOBAL_DEF("rendering/gles4/shaders/shader_cache_size_mb.web", 128);
}
