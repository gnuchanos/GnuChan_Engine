...
Error ProjectSettings::_setup(const String &p_path, const String &p_main_pack, bool p_upwards, bool p_ignore_override) {
	...
	if (exec_path != "") {
		...
		// (This is the usual case when distributing a GnuChan game.)
...
ProjectSettings::ProjectSettings() {
	...
	if (Engine::get_singleton()->has_singleton("GnuChanSharp")) {
	...
	// Required to make the project setting appear even if the physics engine is GnuChanPhysics,
