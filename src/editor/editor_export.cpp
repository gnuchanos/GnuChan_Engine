...
String EditorExportPlatform::test_etc2() const {
	...
	String err;
	if (!etc2_supported) {
		err += TTR("Target platform requires 'ETC2' texture compression. Enable 'Import Etc 2' in Project Settings.");
	}
	return err;
}
...
String EditorExportPlatform::test_etc2_or_pvrtc() const {
	...
	if (!etc2_supported && !pvrtc_supported) {
		err += TTR("Target platform requires 'ETC2' or 'PVRTC' texture compression. Enable 'Import Etc 2' or 'Import Pvrtc' in Project Settings.");
	}
	return err;
}
