...
void EditorSettings::_load_defaults(Ref<ConfigFile> p_extra_config) {
...

	{
		...
		// Some locales are not properly supported currently in GnuChan due to lack of font shaping
	...
	hints["interface/theme/preset"] = PropertyInfo(Variant::STRING, "interface/theme/preset", PROPERTY_HINT_ENUM, "Default,Alien,Arc,GnuChan 2,Grey,Light,Solarized (Dark),Solarized (Light),Custom", PROPERTY_USAGE_DEFAULT);
	...
	hints["editors/3d/navigation/navigation_scheme"] = PropertyInfo(Variant::INT, "editors/3d/navigation/navigation_scheme", PROPERTY_HINT_ENUM, "GnuChan,Maya,Modo");
	...
	// TRANSLATORS: Project Manager here refers to the tool used to create/manage GnuChan projects.
...
void EditorSettings::setup_language() {
	...
	// English-only: no editor or doc translations loaded.
}
