...
EditorAbout::EditorAbout() {
	set_title(TTR("About GnuChan Engine"));
	set_hide_on_ok(true);
	set_resizable(true);
	...
	about_text->set_text(
			String::utf8("\xc2\xa9 2025-present ") + TTR("GnuChan Engine contributors") + ".");
	...
	// Author: GnuChan Engine contributors <gnuchanos@gmail.com>
