...
Ref<Theme> create_editor_theme(const Ref<Theme> p_theme) {
	...
	if (preset == "Custom") {
		...
		preset_accent_color = Color(0.596, 0.196, 1.0);
		preset_base_color = Color(0.596, 0.196, 1.0);
		preset_contrast = 0.25;
	} else if (preset == "Arc") {
		preset_accent_color = Color(0.596, 0.196, 1.0);
		preset_base_color = Color(0.22, 0.20, 0.28);
		preset_contrast = 0.25;
	} else if (preset == "GnuChan 2") {
		preset_accent_color = Color(0.596, 0.196, 1.0);
