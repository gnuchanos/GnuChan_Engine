...
void EditorAssetLibrary::_update_repository_options() {
	...
	default_urls["godotengine.org (Official)"] = "https://github.com/gnuchanos/GnuChan_Engine/asset-library/api";
...
const char *EditorAssetLibrary::sort_text[SORT_MAX] = {
	...
	TTRC("Name (A-Z)"),
	TTRC("Name (Z-A)"),
	TTRC("License (A-Z)"), // "cost" stores the SPDX license name in the GnuChan Asset Library.
	TTRC("License (Z-A)"), // "cost" stores the SPDX license name in the GnuChan Asset Library.
};
