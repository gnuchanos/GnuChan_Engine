...
void ExportTemplateManager::_refresh_mirrors() {
	...
	String current_version = VERSION_FULL_CONFIG;
	const String mirrors_metadata_url = "https://github.com/gnuchanos/GnuChan_Engine/mirrorlist/" + current_version + ".json";
...
Error ExportTemplateManager::install_android_template_from_file(const String &p_file) {
	...
	da->make_dir("android");
	{
		// Add version, to ensure building won't work if template and GnuChan version don't match.
...
ExportTemplateManager::ExportTemplateManager() {
	...
	install_file_dialog->add_filter("*.tpz ; " + TTR("GnuChan Export Templates"));
