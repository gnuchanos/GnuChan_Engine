...
void EditorNode::_notification(int p_what) {
	switch (p_what) {
		...
		case EditorSettings::NOTIFICATION_EDITOR_SETTINGS_CHANGED: {
			...
			p->set_item_icon(p->get_item_index(HELP_ABOUT), gui_base->get_icon("GnuChan", "EditorIcons"));
...
void EditorNode::_menu_option_confirm(int p_option, bool p_confirmed) {
	...
	switch (p_option) {
		...
		case HELP_QA: {
			OS::get_singleton()->shell_open("https://github.com/gnuchanos/GnuChan_Engine/qa/");
		} break;
		case HELP_REPORT_A_BUG: {
			OS::get_singleton()->shell_open("https://github.com/gnuchanos/GnuChan_Engine/issues");
		} break;
		...
		case HELP_COMMUNITY: {
			OS::get_singleton()->shell_open("https://github.com/gnuchanos/GnuChan_Engine");
		} break;
		case HELP_ABOUT: {
...
bool EditorNode::call_build() {
	...
	for (int i = 0; i < build_callback_count && builds_successful; i++) {
		if (!build_callbacks[i]()) {
			ERR_PRINT("A GnuChan Engine build callback failed.");
...
void EditorNode::_update_video_driver_color() {
	...
	if (video_driver->get_text() == "opengl4_3") {
...
EditorNode::EditorNode() {
	...
	p->add_separator();
	p->add_icon_shortcut(gui_base->get_icon("GnuChan", "EditorIcons"), ED_SHORTCUT("editor/about", TTR("About GnuChan Engine")), HELP_ABOUT);
	p->add_icon_shortcut(gui_base->get_icon("Heart", "EditorIcons"), ED_SHORTCUT("editor/support_development", TTR("Support GnuChan Development")), HELP_SUPPORT_GODOT_DEVELOPMENT);
