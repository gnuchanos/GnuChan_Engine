...
HEADER = """\
# LANGUAGE translation of the GnuChan Engine class reference.
# Copyright (c) 2025-present GnuChan Engine contributors (see AUTHORS.md).
# This file is distributed under the same license as the GnuChan source code.
#
...
msgid ""
msgstr ""
"Project-Id-Version: GnuChan Engine class reference\\n"
