...
namespace GodotTools
{
    public class GodotSharpEditor : EditorPlugin, ISerializationListener
    {
        ...
        private bool CreateProjectSolution()
        {
            using (var pr = new EditorProgress("create_csharp_solution", "Generating solution...".TTR(), 3))
            {
                ...
                if (guid.Length > 0)
                {
                    ...
                    pr.Step("Updating GnuChan API assemblies...".TTR());
                    ...
                    {
                        ShowErrorDialog("Failed to update the GnuChan API assemblies: " + debugApiAssembliesError);
                        return false;
                    }
                    ...
                    {
                        ShowErrorDialog("Failed to update the GnuChan API assemblies: " + releaseApiAssembliesError);
                        return false;
                    }
        ...
        public override void EnablePlugin()
        {
            ...
            _editorSettings.AddPropertyInfo(new GnuChan.Collections.Dictionary
            {
