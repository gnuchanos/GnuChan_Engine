...
namespace GodotTools.Export
{
    public class ExportPlugin : EditorExportPlugin
    {
        ...
        private void AddI18NAssemblies(GnuChan.Collections.Dictionary<string, string> assemblies, string bclDir)
        {
        ...
        public void RegisterExportSettings()
        {
            ...
            ProjectSettings.AddPropertyInfo(new GnuChan.Collections.Dictionary
            {
        ...
        public override void _ExportFile(string path, string type, string[] features)
        {
            ...
            if (!includeScriptsContent)
            {
                ...
                // Sadly, GnuChan prints errors when adding an empty file (nothing goes wrong, it's just noise).
                // Because of this, we add a file which contains a line break.
                AddFile(path, System.Text.Encoding.UTF8.GetBytes("\n"), remap: false);

                // Tell the GnuChan exporter that we already took care of the file
                Skip();
            }
        }
        ...
        private void _ExportBeginImpl(string[] features, bool isDebug, string path, int flags)
        {
            ...
            var assemblies = new GnuChan.Collections.Dictionary<string, string>();
        ...
        {
            // OSX export templates are contained in a zip, so we place our custom template inside it and let GnuChan do the rest.
        ...
        /// <summary>
        /// Determines whether the BCL bundled with the GnuChan editor can be used for the target platform,
        ...
        private static extern void internal_GetExportedAssemblyDependencies(GnuChan.Collections.Dictionary<string, string> initialAssemblies,
            string buildConfig, string customBclDir, GnuChan.Collections.Dictionary<string, string> dependencyAssemblies);
    }
}
