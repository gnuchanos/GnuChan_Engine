...
class BindingsGenerator {
	...
	struct MethodInterface {
		...
		/**
		 * Virtual methods ("virtual" as defined by the GnuChan API) are methods that by default do nothing,
		...
		/**
		 * Determines if the call should fallback to GnuChan's object.Call(string, params) in C#.
		 */
