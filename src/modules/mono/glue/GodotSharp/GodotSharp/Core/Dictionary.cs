...
namespace GnuChan.Collections
{
    ...
    /// <summary>
    /// Wrapper around GnuChan's Dictionary class, a dictionary of Variant
    ...
    public class Dictionary : IDictionary, IDisposable
    {
        ...
        /// <returns>A new GnuChan Dictionary.</returns>
    ...
    /// <summary>
    /// Typed wrapper around GnuChan's Dictionary class, a dictionary of Variant
    /// typed elements allocated in the engine in C++. Useful when
