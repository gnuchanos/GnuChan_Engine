...
namespace GnuChan.Collections
{
    ...
    /// <summary>
    /// Wrapper around GnuChan's Array class, an array of Variant
    ...
    public class Array : IList, IDisposable
    {
        ...
        /// <returns>A new GnuChan Array.</returns>
        ...
        /// <returns>A new GnuChan Array with the contents of both arrays.</returns>
    ...
    /// <summary>
    /// Typed wrapper around GnuChan's Array class, an array of Variant
    /// typed elements allocated in the engine in C++. Useful when
    /// interfacing with the engine. Otherwise prefer .NET collections
