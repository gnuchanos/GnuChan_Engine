...
namespace GnuChan
{
    ...
    public static partial class GD
    {
        ...
        [Obsolete("DecTime has been deprecated and will be removed in GnuChan 4.0, use Mathf.MoveToward instead.")]
        ...
        /// <summary>
        /// Pushes an error message to GnuChan's built-in debugger and to the OS terminal.
        ///
        ...
        /// <summary>
        /// Pushes a warning message to GnuChan's built-in debugger and to the OS terminal.
        /// </summary>
        /// <example>
        ...
        ///
        /// Note: Due to limitations with GnuChan's built-in console, this only prints to the terminal.
        ...
        /// <code>
        /// string a = "{\"a\": 1, \"b\": 2 }";
        /// var b = (GnuChan.Collections.Dictionary)GD.Str2Var(a);
        ...
        /// <example>
        /// <code>
        /// var a = new GnuChan.Collections.Dictionary { ["a"] = 1, ["b"] = 2 };
