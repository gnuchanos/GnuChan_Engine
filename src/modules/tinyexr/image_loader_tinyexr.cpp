...
Error ImageLoaderTinyEXR::load_image(Ref<Image> p_image, FileAccess *f, bool p_force_linear, float p_scale) {
	...
	// Re-implementation of tinyexr's LoadEXRFromMemory using GnuChan types to store the Image data
	// and GnuChan's error codes.
	...
	// EXR image data loaded, now parse it into GnuChan-friendly image data
